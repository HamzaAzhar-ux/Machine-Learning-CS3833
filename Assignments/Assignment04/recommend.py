...
Original file is located at
    https://colab.research.google.com/drive/1OoqksnJ_KiPdjPZ4g-7l6ZrFj1lVtYYv
"""
...
##########################################################################
def get_dists(query_title, title2MVec_reweighted):
    """Calculates the Manhattan distance from all movies in title2MVec_reweighted to query_title.
    ...
    def manhattan_distance(mvec1, mvec2):
    ...
    for title, mvec in title2MVec_reweighted.items():
        if title != query_title:
            dists.append((title, manhattan_distance(query_mvec, mvec)))
